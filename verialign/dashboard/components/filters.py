...
def render_model_filter(models: list, key: str = "model_filter", default: str = "All") -> str:
...
def render_task_filter(tasks: list, key: str = "task_filter", default: str = "All") -> str:
    options = ["All"] + sorted(tasks)
    return st.selectbox("Task Category", options, key=key)


def render_limit_slider(key: str = "limit", min_val: int = 10, max_val: int = 500, default: int = 100, step: int = 10) -> int:
